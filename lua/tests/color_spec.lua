...
describe("Color class", function()
  ...
  it("should convert rgb", function()
    ...
    assert.are.same("#123456", test_color:to_vim())
  end)
  ...
  it("should be able to subtract rgb values", function()
    ...
    assert.are.same(test_color:to_vim(), "#888888")
    assert.are.same(subtract_color:to_vim(), "#0000ff")
    assert.are.same(final_color:to_vim(), "#888800")
  end)
  it("should be able to subtract rgb values with variable intensity", function()
    ...
    local final_color = Color.new("result", unpack(result))
    assert.are.same("#888888", test_color:to_vim())
    assert.are.same("#0000ff", subtract_color:to_vim())
    assert.are.same("#888844", final_color:to_vim())
  end)
  it("should be able to add rgb values", function()
    ...
    local final_color = Color.new("result", unpack(result))
    assert.are.same(final_color:to_vim(), "#004401")
  end)
end)
